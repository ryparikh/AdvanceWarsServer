...
| Piperunner | `piperunner` | `units/piperunner/` | partial | partial | `units/piperunner/` covers indirect min/max range, ammo consumption, no ammo, empty target, and move-fire rejection. Pipe movement and attack coverage are tracked by [#35](https://github.com/ryparikh/AdvanceWarsServer/issues/35); production legality is tracked by [#79](https://github.com/ryparikh/AdvanceWarsServer/issues/79). |
| Recon | `recon` | `units/recon/` | partial | partial | Present as production option and infantry combat target/opponent. Owner-side movement/combat coverage is tracked by [#105](https://github.com/ryparikh/AdvanceWarsServer/issues/105); fog vision remains deferred to [#90](https://github.com/ryparikh/AdvanceWarsServer/issues/90). |
