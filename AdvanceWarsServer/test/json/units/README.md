...
| Sub | `sub` | `units/sub/` | yes | yes | `units/sub/` covers surfaced naval combat, ammo use, Sea/Reef/Port movement, Shoal rejection, invalid land/air/no-ammo targets, and begin-turn fuel/Port resupply. Dive, hidden visibility, and fog tracker behavior remain tracked by #16. |
