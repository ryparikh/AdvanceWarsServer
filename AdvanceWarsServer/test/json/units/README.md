...
| MediumTank | `medium-tank` | `units/medium-tank/` | yes | yes | `units/medium-tank/` covers Treads movement over every clear-weather terrain category, full-ammo legal and invalid target/terrain combat cases, primary ammo consumption, no-ammo secondary behavior, invalid no-ammo targets, and direct-combat counterattack expectations. |
